...
Offline GA defaults stay unchanged. Optional cloud scaffolding lives on a separate track — see `docs/OFFLINE_CLOUD_SYNC.md` (**Cloud sync (beta)**). Hosted HTTPS deploy for the sync API: `docs/HOSTED_DEPLOY.md`. Product order: `docs/PRODUCT_ROADMAP.md`.
